...
return [
    ...
    'backups_restore_warning' => 'Gebruik de herstel knop <small><span class="btn btn-xs btn-warning"><i class="text-white fas fa-retweet" aria-hidden="true"></i></span></small> om een vorige back-up te herstellen. (Dit werkt momenteel niet met S3 bestandsopslag of Docker.)<br><br>Je <strong>gehele :app_name database en alle geüploade bestanden zullen volledig vervangen worden</strong>door wat er in het backup bestand staat.  ',
    ...
    'general_settings_keywords' => 'bedrijfsondersteuning, handtekening, acceptantie, e-mailformaat, gebruikersnaam formaat, afbeeldingen, per pagina, thumbnail, eula, gravatar, tos, dashboard, privacy',
    ...
    'help_default_will_use' => '<code>:Standaard</code> gebruikt de waarde van <code>:setting_name</code>. <br>Houd er rekening mee dat de waarde van de streepjescodes moet voldoen aan de respectievelijke streepjescodespecificaties om succesvol te kunnen worden gegenereerd. Raadpleeg <a href="https://snipe-it.readme.io/docs/barcodes">de documentatie <i class="fa fa-external-link"></i></a> voor meer details. ',
    'default' => 'Standaard',
    'none' => 'Geen',
