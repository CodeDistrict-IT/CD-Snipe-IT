...
return [
    ...
    'general_settings_keywords' => 'företagets support, signatur, acceptans, e-postformat, användarnamn format, bilder, per sida, miniatyr, eula, gravatar, tos, instrumentbräda, integritet',
    ...
    'label2_title_help_phold' => 'Platshållaren <code>{COMPANY}</code> kommer att ersättas med tillgången&apos;s företagsnamn',
    'label2_asset_logo' => 'Använd tillgångslogotyp',
    'label2_asset_logo_help' => 'Använd logotypen för tillgången&apos;s tilldelade företag, snarare än värdet på <code>:setting_name</code>',
    ...
    'help_default_will_use' => '<code>:default</code> kommer att använda värdet från <code>:setting_name</code>. <br>Observera att värdet på streckkoderna måste följa respektive streckkodspec för att framgångsrikt kunna genereras. Se <a href="https://snipe-it.readme.io/docs/barcodes">dokumentationen <i class="fa fa-external-link"></i></a> för mer information. ',
    'default' => 'Standard',
    'none' => 'Inga',
    ...
    'mail_reply_to' => 'E-Post Reply-To adress',
